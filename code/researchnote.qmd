...
data$trustGovermax <- Recode(data$trustGover,"1:2 = 0;3:4 = 1")
data$trustLocalmax <- Recode(data$trustLocal,"1:2 = 0;3:4 = 1")

lm_diff_escore4 <- lm(diff_escore4 ~age+party+edu+gender+race+rural+newspol+trustGovermax+incomeFam_level,binomial,data = data)
